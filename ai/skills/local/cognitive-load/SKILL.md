---
name: cognitive-load
description: Write and review code to minimize cognitive load on human readers. Use when writing, reviewing, or refactoring code to keep it within working-memory limits — avoiding deeply-nested conditions, shallow modules, unnecessary abstractions, and other patterns that make code mentally taxing. Based on zakirullin/cognitive-load.
---
